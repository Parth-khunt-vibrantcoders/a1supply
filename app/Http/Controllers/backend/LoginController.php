...
class LoginController extends Controller
{
    ...
    public function check_login(Request $request){
        ...
        if ((Auth::guard('admin')->attempt(['email' => $request->input('email'), 'password' => $request->input('password'), 'is_deleted'=>'N', 'status' => 'A' ])) || (Auth::guard('admin')->attempt(['mobileno ' => $request->input('email'), 'password' => $request->input('password'), 'is_deleted'=>'N', 'status' => 'A' ]))) {
            $loginData = '';
