...
<section class="hero_banner" style="background-image: url({{  asset('public/frontend/images/service-truckload.jpeg') }});">
    <div class="container">
        <div class="banner_text">
            <h1>Services to fit your needs</h1>
            <p>Our fleet and networking services gives you the ability to access to truckload across the United States.</p>
        </div>
