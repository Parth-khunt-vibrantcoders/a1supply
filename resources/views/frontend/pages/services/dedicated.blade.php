...
<section class="hero_banner" style="background-image: url({{  asset('public/frontend/images/service-dedicated.jpeg') }});">
    <div class="container">
        <div class="banner_text">
            <h1>Dedicated transport across the country</h1>
            <p>A1 suppplychain solutions proudly provides efficient and affordable solutions for any size freight. We specialize in private fleet solutions to fit your needs.</p>
        </div>
