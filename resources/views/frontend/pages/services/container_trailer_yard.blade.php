...
<section class="hero_banner" style="background-image: url({{  asset('public/frontend/images/container-trailer-yard.webp') }});">
    <div class="container">
        <div class="banner_text">
            <h1>Container & Trailer Yard Storage Solutions</h1>
            <p>Reduce container and trailer yard congestion on your facility by leveraging one of our many solutions for both container and trailer storage. Do not allow containers to dwell on a marine terminal incurring significant cost in demurrage, we have a dray-off and demand delivery model to support your supply chain needs.</p>
        </div>
